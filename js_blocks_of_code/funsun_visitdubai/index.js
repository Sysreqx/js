...
map.addEventListener("mouseover", (event) => {
    ...
    if (target.classList.contains("map_photo_1")) {
        ...
        //     mapPhoto1_3.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_1_5")) {
        //     mapPhoto1_5.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_1_7")) {
        //     mapPhoto1_7.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_1_8")) {
        //     mapPhoto1_8.classList.remove("transparent-obj");
        // }
        ...
        //     mapPhoto2_1.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_2_2")) {
        //     mapPhoto2_2.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_2_3")) {
        //     mapPhoto2_3.classList.remove("transparent-obj");
        // }
        ...
        //     mapPhoto3_1.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_3_3")) {
        //     mapPhoto3_3.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_3_4")) {
        //     mapPhoto3_4.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_3_5")) {
        //     mapPhoto3_5.classList.remove("transparent-obj");
        // } else if (target.classList.contains("map_photo_3_6")) {
        //     mapPhoto3_6.classList.remove("transparent-obj");
        // }
